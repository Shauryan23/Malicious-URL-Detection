...
URL = "https://job4freshers.co.in/cognizant-hiring-programmer-analyst/"
...
# -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* #
test_input1 = np.array([tld, whois_response[0], url_length, path_rest_length, num_spcs_chars, domain_entropy, whois_response[1], whois_response[2], whois_response[3], whois_response[4], word_count, tld_in_path_rest], dtype=object).reshape(1, 12)

print(test_input1)

pipe = pickle.load(open('./model/classifier.pkl', 'rb'))

print(pipe.predict(test_input1))